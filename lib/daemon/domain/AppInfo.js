...
AppInfo.prototype.afterPropertiesSet = function() {
  var user = this._posix.getpwnam(this.user)
  user.gid = this._posix.getgrnam(this._config.boss.group).gid
  ...
  Object.defineProperties(this, {
    ...
    'path': {
      value: this._config.boss.appdir + '/' + this.id
    }
  })
}
...
AppInfo.prototype.updateRefs = function(onOut, onErr, callback) {
  async.series([
    ...
    callback(error, error ? undefined : result[1])
  })
}
