...
util.inherits(BossRPC, EventEmitter)

BossRPC.prototype.afterPropertiesSet = function(done) {
  // create pass-through methods for boss
  this._getApi().forEach(function(method) {
    if(!this._boss[method]) {
...
BossRPC.prototype._getSocketName = function() {
  return 'socket'
}

BossRPC.prototype._createDnodeServer = function(done) {
      ...
      var checkSocketPresent = function() {
        this._fs.exists(this.socket, function(exists) {
          if(!exists) {
            ...
            setTimeout(checkSocketPresent.bind(this), 10000)
          }
        }.bind(this))
      }.bind(this)
      setTimeout(checkSocketPresent.bind(this), 10000)
...
BossRPC.prototype._getUmask = function() {
...
BossRPC.prototype.broadcast = function() {
