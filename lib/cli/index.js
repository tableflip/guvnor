...
const startWeb = require('./web/start')
...
module.exports = (certs, args, piped) => {
  return new Promise((resolve, reject) => {
    ...
    yargs(args)
      ...
      .command('env', 'Show the environment of a process', bind(processEnv))
      ...
      .command('web', 'Start the web interface', bind(startWeb))
      .command('key', 'Generate a pkcs12 keybundle to access the web interface', bind(webKey))
