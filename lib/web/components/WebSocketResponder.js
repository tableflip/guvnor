...
WebSocketResponder.prototype._checkHost = function() {
  ...
  remote(this._logger, {
    host: this._config.hosts[args.host].host,
    port:  this._config.hosts[args.host].port,
    user: user,
...
WebSocketResponder.prototype.startProcess = function(connection, boss, args, callback) {
  boss.startProcess(args.process, args.options, callback)
}

WebSocketResponder.prototype.stopProcess = function(connection, boss, args, callback) {
  boss.connectToProcess(args.process, function(error, remoteProcess) {
...
WebSocketResponder.prototype.restartProcess = function(connection, boss, args, callback) {
  boss.connectToProcess(args.process, function(error, remoteProcess) {
    if(error) return callback(error)
...
WebSocketResponder.prototype.removeProcess = function(connection, boss, args, callback) {
  boss.removeProcess(args.process, callback)
}

WebSocketResponder.prototype.gcProcess = function(connection, boss, args, callback) {
  boss.connectToProcess(args.process, function(error, remoteProcess) {
    if(error) return callback(error)
...
WebSocketResponder.prototype.heapdumpProcess = function(connection, boss, args, callback) {
  boss.connectToProcess(args.process, function(error, remoteProcess) {
    if(error) return callback(error)
...
WebSocketResponder.prototype.addClusterWorker = function(connection, boss, args, callback) {
  boss.findProcessInfoById(args.process, function(error, processInfo) {
    if(error) return callback(error)
...
WebSocketResponder.prototype.removeClusterWorker = function(connection, boss, args, callback) {
  boss.findProcessInfoById(args.process, function(error, processInfo) {
    if(error) return callback(error)
...
WebSocketResponder.prototype.installApp = function(connection, boss, args, callback) {
  ...
  boss.deployApplication(args.name, args.url, infoBuffer.append.bind(infoBuffer), errorBuffer.append.bind(errorBuffer), function(error) {
    infoBuffer.flush()
    errorBuffer.flush()
...
WebSocketResponder.prototype.removeApp = function(connection, boss, args, callback) {
  boss.removeApplication(args.name, callback)
}

WebSocketResponder.prototype.startApp = function(connection, boss, args, callback) {
  boss.startProcess(args.name, args.options, callback)
}
