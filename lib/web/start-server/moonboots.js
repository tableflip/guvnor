...
var cssDir = path.resolve(__dirname + '/../../web/client/public/css')
//var javascriptDir = path.resolve(__dirname + '/../../web/client/public/javascript')
//var templateDir = path.resolve(__dirname + '/../../web/client/templates')
