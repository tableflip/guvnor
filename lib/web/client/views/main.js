...
module.exports = View.extend({
  ...
  render: function () {
    ...
    document.head.appendChild(domify(require('./head.hbs')()))
    ...
    this.pageSwitcher = new ViewSwitcher(this.queryByHook('page-container'), {
      show: function (newView, oldView) {
        ...
        document.title = _.result(newView, 'pageTitle') || config.DAEMON_NAME
    ...
    this.listenTo(app.router, 'page', this.pageSwitcher.set.bind(this.pageSwitcher))
