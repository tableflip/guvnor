...
CLI.prototype.afterPropertiesSet = function() {
  ...
  this._user = this._posix.getpwnam(process.getuid())
  this._group = this._posix.getgrnam(process.getgid())
  ...
  this._commander
    ...
    .option('-v, --verbose', 'Prints detailed internal logging output')
    .action(this.generateSSLCertificate.bind(this))
...
CLI.prototype.generateSSLCertificate = function(days, options) {
  days = days || 365
