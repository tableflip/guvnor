...
var api = {
  ...
  //listProcessCertificateFingerprints: require('./' + prefix + '/list-process-certificate-fingerprints'),
  //listBasicProcesses: require('./' + prefix + '/list-basic-processes'),
  getProcess: require('./' + prefix + '/get-process'),
  ...
  listProcesses: require('./common/list-processes'),
  removeProcess: require('./common/remove-process'),

  //getBasicProcess: require('./common/get-basic-process'),
