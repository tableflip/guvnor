...
container.register('net', require('net'))
...
container.createAndRegister('processInfoStore', require('./domain/PersistentProcessInfoStore'), ['processInfoObjectFactory', 'processes.json'])
container.createAndRegister('userDetailsStore', require('../common/Store'), ['userDetailsFactory'])
...
container.createAndRegister('portService', require('./service/PortService'))
