...
var key = process.env.GUVNOR_KEY_FILE ? fs.readFileSync(process.env.GUVNOR_KEY_FILE, 'utf8') : process.env.GUVNOR_KEY_FILE
var ca = process.env.GUVNOR_CA_FILE ? fs.readFileSync(process.env.GUVNOR_CA_FILE, 'utf8') : process.env.GUVNOR_CA_FILE
