...
ProcessWrapper.prototype._redirectLogs = function() {
...
ProcessWrapper.prototype._switchToUserAndGroup = function() {
  if(process.env.BOSS_RUN_AS_GROUP) {
    this._logger.info('Setting process gid', process.env.BOSS_RUN_AS_GROUP)
  ...
  if(process.env.BOSS_RUN_AS_USER) {
    this._logger.info('Setting process uid', process.env.BOSS_RUN_AS_USER)
