...
describe('ProcessData', function() {
  ...
  it('should append usage information', function() {
    ...
    expect(data.usage.heapTotal[0].date).to.equal(5)
    expect(data.usage.heapTotal[0].usage).to.equal(123090000)
    expect(data.usage.heapUsed[0].date).to.equal(5)
    expect(data.usage.heapUsed[0].usage).to.equal(43090000)
    expect(data.usage.residentSize[0].date).to.equal(5)
    expect(data.usage.residentSize[0].usage).to.equal(143090000)
    expect(data.usage.cpu[0].date).to.equal(5)
    expect(data.usage.cpu[0].usage).to.equal(98)
    expect(data.usage.latency[0].date).to.equal(5)
    expect(data.usage.latency[0].usage).to.equal(12.32)
  })
